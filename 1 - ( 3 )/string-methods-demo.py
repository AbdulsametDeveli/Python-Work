...
# Not: find metodu bulamazsa -1 döndürür, index metodu hata verir.
result = website.index('com')
result = website.lindex('com')
result = course.rindex('com')



# 7- 'course' içindeki karakterlerin hepsi alfabetik mi? (isalpha, isdigit)
result = course.isalpha() # Hepsi harf mi?
...
# 10- 'Hello World' karekter dizinin 'World' ifadesini 'There' olarak değiştirin.
result = 'Hello World'.replace('World', 'There')

# 11- 'course' karekter dizisini boşluk karakterlerinden ayırın.
result = course.split(' ')
result = result[2]
